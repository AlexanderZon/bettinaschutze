...
<div class="wrap">
    ...
    <h2>Items Lightbox <a href="admin.php?page=page_item_lightbox_add&parent=<?php echo $_GET['parent']; ?>" class="add-new-h2">Add new</a> <a href="admin.php?page=page_item_lightbox_delete&parent=<?php echo $_GET['parent']; ?>" class="add-new-h2">Trash</a> <a href="admin.php?page=page_gallery_lightbox" class="add-new-h2">Back to Galería</a></h2>
    ...
    class GalleriesMainPageTable extends WP_List_Table{
        ...
        public function column_post_title( $item ){
            ...
            return sprintf( '<a href="?page=%1$s&action=%2$s&ID=%3$s&parent=%4$s">%5$s</a> %6$s', 'page_item_lightbox_edit', 'edit', $item['ID'], $item['post_parent'], $item['post_title'], $this->row_actions( $actions ) );
