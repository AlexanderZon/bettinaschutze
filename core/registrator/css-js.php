...
if (!function_exists('css_js_register')) {
	function css_js_register()
	{
		...
		wp_enqueue_style('fancybox-buttons_css', get_template_directory_uri() . '/js/fancybox/helpers/jquery.fancybox-buttons.css');
		wp_enqueue_style('fancybox-thumbs_css', get_template_directory_uri() . '/js/fancybox/helpers/jquery.fancybox-thumbs.css');
		...
		wp_enqueue_script('fancybox-buttons', get_template_directory_uri() . '/js/fancybox/helpers/jquery.fancybox-buttons.js');
		wp_enqueue_script('fancybox-thumbs', get_template_directory_uri() . '/js/fancybox/helpers/jquery.fancybox-thumbs.js');
