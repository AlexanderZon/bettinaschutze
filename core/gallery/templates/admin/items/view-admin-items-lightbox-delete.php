...
<div class="wrap">
    ...
    class GalleriesMainPageTable extends WP_List_Table{
        ...
        public function column_post_title( $item ){
            ...
            $actions = array(
                'edit' => sprintf( '<a href="?page=%s&action=%s&ID=%s">Editar</a>', 'page_item_lightbox_edit', 'edit' , $item['ID'] ),
                'delete' => sprintf( '<a href="?page=%s&action=%s&ID=%s">Papelera</a>', 'page_item_lightbox_delete', 'trash', $item['ID'] )
                );
        ...
        public function column_post_excerpt( $item ){
            ...
            return sprintf( '<img src="%1$s" height="50"/>', $item['post_excerpt']);
