...
jQuery.fn.fs_gallery = function(fs_options) {
	...
	photo_lightbox = function(){
		...
		var item = function(item){
			console.log(item);
			return '<div style="display:inline-block;height:100px;margin-left:5px;margin-right:5px;"><a id="fancybox_'+item.ID+'" class="fancybox fancybox_'+item.ID+'" rel="fancybox_'+item.ID+'" href="'+item.photos[0].src+'" title="'+item.post_title+'"><img src="'+item.thumb+'" alt="" height="100"/></a></div>';
		}
		...
		var video = function(video){
			//console.log(video);
			return '<div style="display:inline-block;height:100px;margin-left:5px;margin-right:5px;"><a id="fancybox_'+video.ID+'" class="fancybox fancybox_'+video.ID+'" rel="fancybox_'+video.ID+'" href="'+video.post_content+'" title="'+video.post_title+'"><img src="'+video.thumb+'" alt="" /></a></div>';
		}
	...
	video_lightbox = function(){
		...
		var item = function(item, first){
			//console.log(item);
			return '<div style="display:inline-block;height:100px;margin-left:5px;margin-right:5px;"><a id="fancybox_'+item.ID+'" class="fancybox fancybox_'+item.ID+'" rel="fancybox_'+item.ID+'" href="'+item.src+'" title="'+item.post_title+'"><img src="'+item.thumb+'" alt="" height="100"/></a></div>';
		}
