...
<div class="wrap">
    ...
    <h2>Gallery Lightbox (Papelera) <a href="admin.php?page=page_gallery_lightbox_add" class="add-new-h2">Añadir nueva</a></h2>
    ...
    class GalleriesMainPageTable extends WP_List_Table{
        ...
        public function __construct(){
            ...
            $this->data = $gldb->getGalleries('trash');
        ...
        public function column_post_title( $item ){
            ...
            $actions = array(
                'edit' => sprintf( '<a href="?page=%s&action=%s&ID=%s">Restaurar</a>', 'page_gallery_lightbox_edit', 'untrash' , $item['ID'] ),
